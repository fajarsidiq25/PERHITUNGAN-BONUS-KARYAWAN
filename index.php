  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container" style="padding-top: 10px;">
        <center><h4>Mengitung Bonus Karyawan</h4></center>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h4>PROJECT MENGHITUNG BONUS</h4>
        
        <hr>
        <center>
          <button data-toggle="modal" data-target="#modal-hitung" class="btn btn-primary">Menghitung</button>
        </center>
      </div>
      </nav>
